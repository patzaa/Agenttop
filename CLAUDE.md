...
Kernregeln in Kürze: Zustand = Glyph+Farbe+Text (nie Farbe allein) · single-width-
Glyphen, nie Emoji (double-width schert Spalten) · ok-Farbe nur an Glyphen ·
Farbbudget gehört der Abweichung („Ruhe — nichts schreit") · bg = Terminal-Default.
